...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "e3QwQLpB#Yt3qvoDEdGpXXJEJHFRtHdwww9nAnONyteO7MoQGQ_o",
...
AUTO_READ: process.env.AUTO_READ || "commands", // (options: all, commands, none)
